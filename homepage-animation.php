<?php /*
Template Name: Home with Animation
*/
...
<div class="container" id="homepage-container">
	...
	<div class="row animation-row">
		<div class="col-lg-7">
			<h1 class="animation-header">Direct Mail Marketing Can Be Puzzling...</h1>
		</div>
	</div>
	...
	<div class="row homepage-row">
		<div class="col-lg-5 pull-right cube-col">
			<div class="home-gif-wrap">
				<img class="home-gif" src="http://highperformancedm.com/wp-content/uploads/2013/08/redCube_HD_v4.gif" />

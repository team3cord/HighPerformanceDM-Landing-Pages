...
<div class="mc-wrap whitey">
    ...
    <aside class="response-top-left">
        <p class="red-top">This ControlBEATER test<br>
            recommendation was written<br>
            for a major insurance maile<br>
            who’s program respons<br>
            rates were in serious<br>
            decline.</p>
    ...
    <div class="pdf-holder">
        ...
        <?php echo do_shortcode('[gview file="http://hpdm.crosshatchcreative.com/wp-content/uploads/2014/06/hpdm-rec.pdf"]')?>
    </div>

...
<div class="mc-wrap whitey">
    ...
    <div class="pdf-holder">
        ...
        <?php echo do_shortcode('[gview file="http://highperformancedm.com/wp-content/uploads/2014/06/HPDM-Test-Recomendation.pdf"]')?>
        <div class="click-to-download">
            <span>Click to <a class="red-link" href="http://highperformancedm.com/wp-content/uploads/2014/06/HPDM-Test-Recomendation.pdf" target="_blank">download</a> </span>
        </div>
    </div>
